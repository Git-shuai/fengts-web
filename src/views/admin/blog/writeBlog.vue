          ...
          <el-form :model="blogDetails" status-icon ref="blogDetails" label-width="75px">
            ...
            <el-form-item label="文章分类:" prop="classify">
              ...
              <el-card class="box-card" v-if="isClassifyBack">
                ...
                <div>
                  <div class="tabs-span">
                    <span v-for="item in classifyList" @click="selectClassify(item)"
                          :key="item.id">{{ item.classifyName }}</span>
                  </div>
                </div>
              </el-card>
            </el-form-item>
            ...
            <el-form-item label="封面图" prop="blogType">
              <el-image  class="image-upload blogUrl-image" style="width: 100px; height: 100px" :src="blogDetails.blogUrl"></el-image>
              <el-button class="btn-img" type="warning" @click="drawer = true" icon="el-icon-edit" circle></el-button>
            </el-form-item>
        ...
        <div class="drawer-url">
          ...
          <div>
            <el-upload
              ...
              <el-image class="image-upload" v-if="blogDetails.blogUrl" :src="blogDetails.blogUrl"></el-image>
            </el-upload>
          </div>
        </div>
      </el-drawer>
  ...
  data() {
    ...
    return {
      ...
      blogDetails: {
        ...
        //文章状态
        blogStatus: "",
        blogUrl: "https://cube.elemecdn.com/6/94/4d3ea53c084bad6931a56d5158a48jpeg.jpeg"
      },
      //弹出窗
      dialogVisible: false,
      //Tag列表
  ...
  methods: {
    ...
    saveDraft() {
      ...
      let data = {
        ...
        "isComment": "0",
        "blogStatus": "草稿箱",
        "blogUrl": this.blogDetails.blogUrl
      };
    ...
    upLoad(file) {
      ...
      uploadOss(formData).then(res=>{
        this.blogDetails.blogUrl=res.data.data;
      }).catch()
